          ...
          <div className="flex flex-row gap-10">
            <div className="flex flex-col gap-5 basis-2/3">
              ...
              <p className="text-2xl text-balance">
                I&apos;m a recent Computer Science graduate from Virginia Tech.
                I made this website to share some of my work and experiences in
                a more personal way without all of the business buzzwords and
